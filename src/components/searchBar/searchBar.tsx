...
import {setSearchString} from "../../app/model/contentSlice";
...
const SearchBar = () => {
    ...
    return (
        <div className="searchBar">
            <input className="searchBar__input" type={"text"} placeholder="Поиск" value={state.content.searchString}
                   onChange={(e) => {
                        if(state.content.searchString !== e.target.value) {
